package com.redis.monitor.rest.sys;

import com.alibaba.fastjson.JSONObject;
import com.redis.monitor.aop.LogAsync;
import com.redis.monitor.busi.sys.OrgServiceImpl;
import com.redis.monitor.busi.sys.exp.OrgQueryExp;
...
public class OrgController {
    ...
    @LogAsync(module = "DEPARTS", op = "ORG_QUERY")
    ...
    @LogAsync(module = "DEPARTS", op = "ORG_UPDATE")
    ...
    @LogAsync(module = "DEPARTS", op = "ORG_ADD")
    ...
    @LogAsync(module = "DEPARTS", op = "ORG_DEL")
